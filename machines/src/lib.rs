...
impl MachineIdentificationUnique {
    pub fn as_u64(&self) -> u64 {
        ...
        ((self.machine_ident.vendor as u64) << 48) | ((self.machine_ident.machine as u64) << 32) | (self.serial as u64)
    }
}
...
pub struct MachineDataRegistry {
    ...
    pub storage: HashMap<MachineIdentificationUnique, [u8; MAX_DATA_LEN]>, 
}
