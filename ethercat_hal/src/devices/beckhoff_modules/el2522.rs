...
impl EL2522Configuration {
    fn write_channel_config<'a>(
        ...
        ecat_channel.sdo_write(
            ...
            pto_base_index,
            0x01,
            config.adapt_a_b_on_position_set,
        )?;
        ecat_channel.sdo_write(
            device_address,
            pto_base_index,
            0x02,
            config.emergency_ramp_active,
        )?;
        ecat_channel.sdo_write(
            device_address,
            pto_base_index,
            0x03,
            config.watchdog_timer_deactive,
        )?;
        ecat_channel.sdo_write(
            device_address,
            pto_base_index,
            0x04,
            config.sign_amount_representation,
        )?;
        ecat_channel.sdo_write(
            device_address,
            pto_base_index,
            0x06,
            config.ramp_function_active,
        )?;
        ecat_channel.sdo_write(
            device_address,
            pto_base_index,
            0x07,
            config.ramp_base_frequency,
        )?;
        ecat_channel.sdo_write(
            device_address,
            pto_base_index,
            0x08,
            config.direct_input_mode,
        )?;
        ecat_channel.sdo_write(
            device_address,
            pto_base_index,
        ...
        ecat_channel.sdo_write(
            ...
            pto_base_index,
            0x0A,
            config.travel_distance_control,
        )?;
        ecat_channel.sdo_write(
            device_address,
            pto_base_index,
            0x0E,
            u8::from(config.operating_mode),
        )?;
        ...
        ecat_channel.sdo_write(
            ...
            pto_base_index,
            0x11,
            config.user_switch_on_value,
        )?;
        ecat_channel.sdo_write(
            device_address,
            pto_base_index,
            0x12,
            config.base_frequency_1,
        )?;
        ecat_channel.sdo_write(
            device_address,
            pto_base_index,
            0x13,
            config.base_frequency_2,
        )?;
        ecat_channel.sdo_write(
            device_address,
            pto_base_index,
            0x14,
            config.ramp_time_constant_rising,
        )?;
        ecat_channel.sdo_write(
            device_address,
            pto_base_index,
            0x15,
            config.ramp_time_constant_falling,
        )?;
        ecat_channel.sdo_write(
            device_address,
            pto_base_index,
            0x16,
            config.frequency_factor,
        )?;
        ecat_channel.sdo_write(
            device_address,
            pto_base_index,
            0x17,
            config.slowing_down_frequency,
        )?;
        ecat_channel.sdo_write(
            device_address,
            pto_base_index,
            0x18,
            config.ramp_time_constant_emergency,
        )?;
        // Write ENC settings
        ...
        ecat_channel.sdo_write(
            ...
            enc_base_index,
            0x0A,
            config.enable_micro_increments,
        )?;
        ecat_channel.sdo_write(
            device_address,
            enc_base_index,
            0x18,
            config.micro_increment_bits,
        )?;
        ecat_channel.sdo_write(
            device_address,
            enc_base_index,
